...
from onl.platform.liteon import *

class OnlPlatform_x86_64_liteon_tgsm602_54x_r0(OnlPlatformLiteon,
                                              OnlPlatformPortConfig_48x10_6x40):
    PLATFORM='x86-64-liteon-tgsm602-54x-r0'
    MODEL="TGSM602-54X"
    SYS_OBJECT_ID=".6000.64.1"

    def baseconfig(self):

        self.insmod('cpr_4011_4mxx')
        self.insmod('liteon_i2c_cpld')
        ...
        self.new_i2c_devices(
            [
                ('liteon_i2c_cpld', 0x60, 0),
                ('liteon_i2c_cpld', 0x61, 0),
                ('liteon_i2c_cpld', 0x62, 0),
                ]
            )
        ...
        self.new_i2c_devices(
            [
                ...
                ('tgsm602_54x_psu', 0x38, 59),
                ('cpr_4011_4mxx',  0x3c, 59),

                # initiate PSU-2 AC Power
                ('tgsm602_54x_psu', 0x3b, 60),
